...
export const HeroSection = () => {
  return (
    <section className="container flex justify-between items-center mt-[116px] max-md:mt-10 relative px-4 max-w-7xl mx-auto">
      <img
        ...
        alt="Decorative"
        className="absolute left-0 aspect-[0.32] object-contain w-[189px] max-w-full"
      />

      <div className="flex flex-col items-center mx-auto max-w-4xl z-10">
      ...
      <img
        ...
        alt="Decorative"
        className="absolute right-0 aspect-[0.34] object-contain w-[201px] max-w-full"
      />
    </section>
  );
};
